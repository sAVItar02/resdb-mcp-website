    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto mb-12 leading-relaxed">
          The official Model Context Protocol (MCP) server for ResilientDB. 
        ...
        <div className="mt-20 lg:mt-32 opacity-30 animate-bounce">
          <ChevronDown className="w-6 h-6 mx-auto text-gray-900" />
        </div>
      </div>
    </section>
  );
